...
class BrainorPayCommissions extends Section
{
    public static function onDisplay(){
        $display = Display::table([
            Column::text('id', '#'),
            Column::text('brainorPayBank.name', 'Банк'),
            Column::text('value', 'Процент'),
            Column::text('min_value', 'Минимальная сумма'),
        ...
        $form = Form::panel([
            FormColumn::column([
                FormField::select('bank_id', 'Банк')
                    ...
                    ->setDisplay('name')
                    ->setRequired(true),
                FormField::input('value', 'Процент')->setRequired(true),
                FormField::input('min_value', 'Минимальная сумма')->setRequired(true),
            ]),
        ]);
